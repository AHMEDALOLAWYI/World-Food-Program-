...
class MaskRCNN(nn.Module):
    ...
    def build(self, config):
        ...
        #self.fpn = FPN_original(C1, C2, C3, C4, C5, out_channels=256)
        
        #optional: feed in a resnet50 with loaded weights (but exclude everything from the pooling layer onwards)
        self.fpn = FPN_new(create_body(models.resnet50),256)
